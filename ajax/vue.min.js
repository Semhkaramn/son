...
!(function (e, t) {
        ...
        if (!M(e)) {
            ...
            if ((P(e) && (e = o.extend(e)), "function" == typeof e)) {
                ...
                if (
                    ...
                    return (s = a), (c = t), (l = n), (u = r), (f = i), ((p = fe()).asyncFactory = s), (p.asyncMeta = { data: c, context: l, children: u, tag: f }), p;
                (t = t || {}),
                    dn(e),
                    D(t.model) &&
                        (function (e, t) {
    ...
    ($n = hn),
        ...
        k.forEach(function (n) {
            wn[n] = function (e, t) {
                return t
                    ? ("component" === n && l(t) && ((t.name = t.name || e), (t = this.options._base.extend(t))), "directive" === n && "function" == typeof t && (t = { bind: t, update: t }), (this.options[n + "s"][e] = t))
                    : this.options[n + "s"][e];
            };
        }),
    ...
    function _i(e, t) {
        var n,
            ...
            f = 0;
        return (
            t === si ? 0 < a && ((n = si), (u = a), (f = o.length)) : t === ci ? 0 < l && ((n = ci), (u = l), (f = c.length)) : (f = (n = 0 < (u = Math.max(a, l)) ? (l < a ? si : ci) : null) ? (n === si ? o.length : c.length) : 0),
        ...
        inserted: function (e, t, n, r) {
            "select" === n.tag
                ...
                : ("textarea" === n.tag || Kn(e.type)) &&
                  ((e._vModifiers = t.modifiers), t.modifiers.lazy || (e.addEventListener("compositionstart", Li), e.addEventListener("compositionend", Ii), e.addEventListener("change", Ii), J && (e.vmodel = !0)));
        },
    ...
    function ga(e, t, n) {
        return t.for && !t.forProcessed
            ...
            : "{key:" + e + ",fn:" + ("function(" + String(t.slotScope) + "){return " + ("template" === t.tag ? (t.if ? t.if + "?" + (_a(t, n) || "undefined") + ":undefined" : _a(t, n) || "undefined") : da(t, n)) + "}") + "}";
        var r, i, o, a, s, c, l;
    }
